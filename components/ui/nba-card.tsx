    ...
    <div className={cn(
      ...
      <div className="relative z-10">
        ...
        <div className="border-t border-gray-200 pt-5 mb-5">
          <p className="text-sm text-gray-600 mb-3 leading-relaxed">{explanation}</p>
          <div className="flex items-start gap-2 px-4 py-3 rounded-lg bg-gray-50 border border-gray-200">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button size="sm" variant="ghost" className="gap-1.5 ml-auto text-burgundy-600 hover:text-burgundy-700">
            View Evidence
